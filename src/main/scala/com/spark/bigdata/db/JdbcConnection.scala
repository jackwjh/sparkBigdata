...
/**
  ...
  */
private[bigdata] trait JdbcConnection {
...
private[bigdata] object MysqlConnection {
...
private[bigdata] object Db2Connection {
...
object JdbcUtil {
  ...
  def mysql2DF(table: String, rootNode: String = "source", numPartitions: Int = numPartitions, configName: String = "mysql2mysql")(implicit sparksession: SparkSession): DataFrame = {
    val mysql = MysqlConnection.build(configName, rootNode)
    import mysql._
    sparksession.jdbcDF(table, numPartitions)
  }
  ...
  def db2JdbcDF(table: String, numPartitions: Int = numPartitions, configName: String = "db2mysql", rootNode: String = "source")(implicit sparksession: SparkSession): DataFrame = {
